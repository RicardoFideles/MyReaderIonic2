...
export class HomePage {
  ...
  constructor(public navCtrl: NavController, public http: Http, public loadingCtrl: LoadingController, public actionSheetCtrl: ActionSheetController, private iab: InAppBrowser, public redditService: RedditServiceProvider) {
    this.fetchContent();
  }
